...
show_menus() {
 ...
 figlet -f digital "1. Reboot System"
 figlet -f digital "2. Start Miner"
 figlet -f digital "3. Fix mdadm.conf No Array"
 figlet -f digital "4. Install Miner Every Boot"
 figlet -f digital "5. Install cpuminer-multi"
 figlet -f digital "6. Install minergate-cli"
 figlet -f digital "7. Run Miner In Background"
